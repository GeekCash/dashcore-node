...
module.exports.services.GeekCash = require('./lib/services/geekcashd');
...
module.exports.cli.geekcashcore = require('./lib/cli/geekcashcore');
module.exports.cli.geekcashcored = require('./lib/cli/geekcashcored');

module.exports.lib = require('@geekcash/geekcash-lib');
