...
var geekcashnode = require('..');
var utils = require('../utils');

function main(servicesPath, additionalServices) {
  /* jshint maxstatements: 100 */

  var version = geekcashnode.version;
  var create = geekcashnode.scaffold.create;
  var add = geekcashnode.scaffold.add;
  var start = geekcashnode.scaffold.start;
  var remove = geekcashnode.scaffold.remove;
  var callMethod = geekcashnode.scaffold.callMethod;
  var findConfig = geekcashnode.scaffold.findConfig;
  var defaultConfig = geekcashnode.scaffold.defaultConfig;
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the GeekCash database directory')
  ...
  program
    ...
    .option('-c, --config <dir>', 'Specify the directory with GeekCashcore Node configuration')
    .option('-d, --daemon', 'Make geekcash-node a daemon (running in the background)')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `geekcash-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ geekcash-node add wallet-service');
      console.log('    $ geekcash-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ geekcash-node remove wallet-service');
      console.log('    $ geekcash-node remove insight-api');
      console.log();
    });
